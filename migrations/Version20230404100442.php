 ...
 */
final class Version20230404100442 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE status_serie (id INT AUTO_INCREMENT NOT NULL, user_episode_id INT DEFAULT NULL, stat_ep_serie_id INT DEFAULT NULL, nb_episode_user INT DEFAULT NULL, INDEX IDX_5D60C2C4914CA44C (user_episode_id), INDEX IDX_5D60C2C4750528D0 (stat_ep_serie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE status_serie ADD CONSTRAINT FK_5D60C2C4914CA44C FOREIGN KEY (user_episode_id) REFERENCES `user` (id)');
        $this->addSql('ALTER TABLE status_serie ADD CONSTRAINT FK_5D60C2C4750528D0 FOREIGN KEY (stat_ep_serie_id) REFERENCES serie (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE status_serie DROP FOREIGN KEY FK_5D60C2C4914CA44C');
        $this->addSql('ALTER TABLE status_serie DROP FOREIGN KEY FK_5D60C2C4750528D0');
